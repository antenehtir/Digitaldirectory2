...
},
{
 ...
 // Function to populate the area dropdown and datalist
  function populateAreaOptions() {
    ...
    const datalist = document.getElementById("areaSuggestions");
    datalist.innerHTML = "";
    ...
    areas.forEach(a => {
      ...
      option.value = a.toLowerCase().trim();
  ...
  // Populate area options when subCity changes and on page load
  ...
  filterForm.addEventListener("submit", function (e) {
    ...
    const subCity = subCityEl.value.toLowerCase().trim();
    // Use the text input value if provided; otherwise, use the dropdown selection.
